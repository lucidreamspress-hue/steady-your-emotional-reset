...
const HowItWorksSection = () => {
  ...
  return (
    <section id="how-it-works" style={{ paddingTop: "64px", paddingBottom: "64px" }}>
      <div className="mx-auto max-w-6xl" style={{ paddingLeft: "32px", paddingRight: "32px" }}>
        ...
        {/* DESKTOP: steps left, rotating image right */}
...
{steps.map((step, idx) =>
  activeImage === idx ? (
    ...
    />
        ...
        {/* MOBILE: stacked cards, one after another, same as EmotionalStatesSection */}
        <div className="md:hidden" style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
          {steps.map((step, i) => (
            <motion.div
              key={step.number}
              initial={{ opacity: 0, y: 20 }}
